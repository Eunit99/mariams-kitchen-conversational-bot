 ...
 ** Response = How the system responds to the answer, usually followed by the
 *next question
 ** Copyright (c) Eunit 2019 - 2020
 ** Licensed under MIT License
 *(https://github.com/Eunit99/Helene-UI/blob/master/LICENSE)
 */
...
var questions = {
  0 : {
    ...
    answers : {
      ...
      "carte|a la carte|one|1" : {
        replies : [
          "Great! Please make use of our <a target='_blank' href='https://www.mariamskitchen.nyc/menu'>menu</a> page to choose your dishes."
        ],
      },
      "catering|two|2" : {
        replies : [
  ...
  1 :
      {
        ...
        answers : {
          ...
          "please tell me" : {
            replies : [
              "Please make use of FAQs to learn more. Please click this link to read our <a target='_blank' href='https://www.mariamskitchen.nyc/#faqs' title='read our FAQs' class='link'>FAQs</a>."
            ],
          },
          "i don't|don't|no" : {
            replies : [ "Thank you." ],
    ...
    answers :
        {
          ...
          "contact|reach you|phone|number" : {
            replies : [
              "You can contact Mariam's Kitchen customer care through this number <a href='tel:475-289-6039'>475-289-6039</a>"
            ],
          },
          "email" : {
            replies : [
          ...
          "buffet-style|buffet|plated meals|plate" :
              {
                replies : [
                  "Yes, we offer buffet-style", "Please find more information our <a target='_blank' href='https://www.mariamskitchen.nyc/order-now' title='Use our catering form to order' class='link'>catering form</a>."
                ],
              },
          "i want to order|i would like to order|i am ordering|ordering" : {
            replies : [
              "Great! Please make use of our <a target='_blank' href='https://www.mariamskitchen.nyc/menu'>menu</a> page to choose your dishes.",
              "Also, take a look at our <a target='_blank' href='https://mariamskitchen.nyc/s/Mariams-Kitchen-menu-1.pdf' title='Download our menu' class='link'>menu</a> for other options to choose from. "
            ],
          },
          ...
          "additional fee|hidden fee|terms & condition" : {
            replies :
                [ "Yes, there is a tax applied to all orders, which is 8.8%" ],
          },
          "catering services" : {
            replies : [
          ...
          "weekend order|when to order weekend special|weekend special" : {
            replies : [
              "You can place your orders between Mondays 12pm – Wednesdays 11:59pm."
            ],
          },
          ...
          "no question|no questions| i don\'t have question|thank you" : {
            replies : [
              "No worries if you do not have any questions at the moment."
            ],
          },
        },
  },
  ...
  3 : {
    ...
    answers : {
      ...
      "buffet-style|buffet|plated meals|plate" : {
        replies : [
          "Yes, we offer buffet-style",
          "Please find more information our <a target='_blank' href='https://www.mariamskitchen.nyc/order-now' title='Use our catering form to order' class='link'>catering form</a>."
        ],
      },
      "i want to order|i would like to order|i am ordering|ordering" : {
        replies : [
          "Great! Please make use of our <a target='_blank' href='https://www.mariamskitchen.nyc/menu'>menu</a> page to choose your dishes.", "Also, take a look at our <a target='_blank' href='https://mariamskitchen.nyc/s/Mariams-Kitchen-menu-1.pdf' title='Download our menu' class='link'>menu</a> for other options to choose from. "
        ],
      },
      "hours|operation hours|working hours|are you open|open" : {
        replies : [ "Wednesdays-Saturdays 1pm-10pm" ],
  ...
  5 : {
    ...
    question : [
      "See ya! 👋",
      "<a onclick='location.reload()' class='link'>Restart conversation</a>",
      "-- CONVERSATION END --"
    ],
    ending : true,
  },
