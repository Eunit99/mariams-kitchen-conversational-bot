...
var questions = {
  ...
  1 : {
    ...
    answers : {
      ...
      "please tell me" : {
        replies : [
          "Please make use of FAQs to learn more. Please read our <a target='_blank' href='https://www.mariamskitchen.nyc/#faqs' title='read our FAQs' class='link'>FAQs</a>."
        ],
      },
      "i don't|don't|no" : {
        replies : [ "Thank you." ],
        ...
        answers :
            {
              ...
              "payment methods|pay|cash|card" : {
                replies :
                    [ "We accept cash, credit cards and Zelle payments." ],
              },
              ...
              "average cost|per person|cost" : {
                replies :
                    [ "The average cost per person is between $25 and $35" ],
              },
