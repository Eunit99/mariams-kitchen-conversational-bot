...
var questions = {
  ...
  1 : {
    ...
    answers : {
      ...
      "i don't|don't|no" : {replies : [ "Thank you." ]},
      "yes|yeah|great|sure|of|course" :
          {replies : [ "What would you like to know about Mariam's Kitchen?" ]},
      "maybe|undecided" : {
        replies : [
          "Maybe 🤔", "What would you like to know about Mariam's Kitchen?"
        ]
      },
      "carte|a la carte|1" : {
        replies : [
  ...
  2 : {
    ...
    answers : {
      ...
      "opening hours|working hour|operation hour " : {replies : [ "" ]},
      ...
      "indoor catering|outdoor catering" : {replies : [ "" ]},
      ...
      "payment|catering payment|catering service" : {replies : [ "" ]},
      ...
      "order change|change order|add order|cancel order|catering order|last minute" :
          {replies : [ "" ]},
      "maximum guests|minimum guests|guests number" : {replies : [ "" ]},
      ...
      "popular dishes|favorite dishes" : {replies : [ "" ]},
      "takeaway order|takeaway|takeaway service" : {replies : [ "" ]},
      ...
      "desserts|signature desserts" : {replies : [ "" ]},
      ...
      "ingredients|organic ingredients|local ingredients|ingredient source" :
          {replies : [ "" ]},
      "daily specials|daily promotions|promotions" : {replies : [ "" ]},
      "gift cards|purchase gift card" : {replies : [ "" ]},
      ...
      "merchandise|branded products|purchase merchandise|purchase branded products" :
          {replies : [ "" ]},
      "wait for|wait time|takeaway wait time" : {replies : [ "" ]},
      "large groups|reservation for large groups|reservation required" :
          {replies : [ "" ]},
      "bring wine|bring alcohol|bring beverages" : {replies : [ "" ]},
      "children|children options|children menu" : {replies : [ "" ]},
  ...
  4 : {
    ...
    answers : {
      ...
      awesome : {replies : [ "<b>Awesome</b>! Nice to hear 👌" ]},
      great : {replies : [ "<b>Great</b>! Nice to hear 👌" ]},
      "better|best" : {replies : [ "<b>Better</b>! Nice to hear 👌" ]},
      good : {replies : [ "<b>Good</b>! Nice to hear 👌" ]},
      bad : {replies : [ "<b>Bad</b>! We are working to make it better 👌" ]}
    }
  },
  5 : {
    name : "ending",
